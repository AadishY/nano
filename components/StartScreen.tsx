    ...
    >
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        ...
        <p className="max-w-2xl text-lg text-gray-400 md:text-xl">
          Generate new images from text, retouch photos, apply creative filters, or make professional adjustments. No complex tools needed.
        </p>
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <input id="image-upload-start" type="file" className="hidden" accept="image/*" onChange={handleFileChange} />
             ...
             <button
                ...
                className="relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-gray-200 bg-white/10 rounded-full cursor-pointer group hover:bg-white/20 transition-colors border border-gray-700"
              >
                <MagicWandIcon className="w-6 h-6 mr-3 text-blue-400 transition-transform duration-500 ease-in-out group-hover:rotate-[360deg] group-hover:scale-110" />
                Generate Image
            </button>
        </div>
         <p className="text-sm text-gray-500 -mt-2">or drag and drop a file to upload</p>
        ...
        <div className="mt-16 w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    ...
                    <p className="mt-2 text-gray-400">Use simple text prompts to remove blemishes, change colors, or add elements with pinpoint accuracy.</p>
                </div>
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-700 rounded-full mb-4">
